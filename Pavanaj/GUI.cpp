...
void HelpCB(Fl_Widget* w, void* p)
{
	...
	buff->text(
		...
		"\n"
		"\nSales Associate :"
		"\n1. The Sales Associate can create an order for a customer."
		"\nThe Sales Associate will be prompted to enter his / her information and information for the Customer and order."
		"\n2. The Sales Associate can also search orders via order number and print the bill of sale of his / her choice."
		"\n3. The Sales Associate may also generate a report of all of his / her itemized sales and sales totals.
		"\n"
		"\nCustomer:"
